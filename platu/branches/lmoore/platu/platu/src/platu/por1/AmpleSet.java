...
public class AmpleSet {
			                                                           ...
			                                                           LPNTranRelation lpnTranRelation)
   {
	...
	public LPNTranSet generateAmpleTranSet(LinkedList<LPNTran>[] enabledArray,
	...
	public LPNTranSet generateAmpleTranSet(LPNTranSet enableTranSet,HashMap<LPNTran,HashSet<LPNTran>> allIndepSet)
	{
		LPNTranSet ampleSet = new LPNTranSet();
		if(enableTranSet.size()==0)
		{
	 ...
	 * @return
	 */
	private LPNTranSet getSubset_noInterleaving(LPNTranSet enableTranSet,
	 ...
	 * @return
	 */
		private LPNTranSet getSubset_withInterleaving1(LPNTranSet interleavingEnabledSet,
													   LPNTranSet enableTranSet,
				                                       HashMap<LPNTran,HashSet<LPNTran>> indepTranSet,
