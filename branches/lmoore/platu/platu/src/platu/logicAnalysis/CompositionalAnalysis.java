...
//			reduce(csg);
//			System.out.println(csg.numCompositeStates() + ": " + csg.numTransitions);
//			csg.draw();
...
//			System.out.println("state: " + count + " (" + currentState.getLabel() + ")");
			boolean containsInvisible = true;
			
//			while(containsInvisible){
				containsInvisible = false;
				
//				System.out.println("    enabled: " + currentState.enabledTranList.size());
				
				int size = currentState.enabledTranList.size();
...
//					System.out.println("nextState.enabledTranList.size(): " + nextState.enabledTranList.size());
					int nextSize = nextState.enabledTranList.size();
...
//							System.out.println(containsInvisible);
						}
						
//						System.out.println(invisibleTran + ": " + lpnTran);
						boolean add = true;
	...
	//				removeStateList.add(nextState);
	//				removeTranList.add(invisibleTran);
				}
...
//		System.out.println("   --> Elapsed time: " + elapsedTimeSec + " sec");
	...
	public void redundantStateRemoval(StateGraph sg){
