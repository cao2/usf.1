...
public class Poset {
	...
	public void initialize(LPNTran firedTran, LPNTranSet[] nextEnabledArray) {
	...
	public Poset update(LPNTran firedTran, LPNTranSet[] curEnabledArray, LPNTranSet[] nextEnabledArray) {
