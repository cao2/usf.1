...
public class Zone1 {
	 ...
	 */
	public Zone1(Poset curPoset, LPNTranSet[] nextEnabledArray) {		
	 ...
	 * @param initEnSet
	 */
	final public void initialize(LPNTranSet[] initEnabledArray) {
		this.enabledSet = new DualHashMap<LPNTran, Integer>();
	 ...
	 */
	public Zone1 update(LPNTran firedTran, LPNTranSet[] nextEnabledArray) {
	...
	public Zone1[] split(LPNTranSet[] enabledArray) {
...
//            }
	...
	public LinkedList<Integer> enlarge(LPNTranSet[] enabledArray) {
